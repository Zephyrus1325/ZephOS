...
#define SP804_TIMER1_CONTROL ((volatile uint8_t*)(SP804_TIMER_BASE + 0x08))
...
#define SP804_TIMER2_CONTROL ((volatile uint8_t*)(SP804_TIMER_BASE + 0x28))
...
void k_timer_init(uint8_t timer_id, uint32_t trigger_value) {
    ...
    if(!timer_id){
        ...
        *SP804_TIMER1_CONTROL = (1 << 7) | (1 << 6) | (1 << 5) | (1 << 1);
        ...
        *SP804_TIMER2_LOAD = trigger_value;
        ...
        // Timer Control: Enable (7), Periodic (6), Int Enable (5), 32-bit (1)
        *SP804_TIMER2_CONTROL = (1 << 7) | (1 << 6) | (1 << 5) | (1 << 1);
